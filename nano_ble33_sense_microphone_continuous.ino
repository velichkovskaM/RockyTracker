...
#define EI_CLASSIFIER_INTERVAL_MS 200  // instead of 100
...
void loop()
{
    ...
    // The other device ID and both addresses
    ...
    if (++print_results >= (EI_CLASSIFIER_SLICES_PER_MODEL_WINDOW)) {
        ...
        // if noise classification is lower than 50%, send the message
        if (result.classification[1].value < 0.5) {
            ...
            // size of rocks 0 = small, 1 = big
            ei_printf("size: %s\n", result.classification[2].value > result.classification[0].value ? "0" : "1");
        }
